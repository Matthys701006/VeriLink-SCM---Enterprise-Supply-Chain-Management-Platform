/*
  # VeriLink SCM - Transportation, Finance & Analytics Migration

  1. New Tables
    - `carriers` - Transportation carrier management
    - `vehicles` - Fleet and vehicle tracking
    - `routes` - Route optimization and planning
    ...
    - `cost_centers` - Budget and cost center management
    - `contracts` - Contract lifecycle management
    - `analytics_snapshots` - Performance analytics storage
    - `ml_models` - Machine learning model registry
    - `iot_sensors` - IoT sensor device management
    - `sensor_readings` - Time-series sensor data

  2. Security
    - Enable RLS on all tables
    - Add organization-scoped policies for data isolation
    - Create performance indexes for scalability

  3. Features
    - Real-time shipment tracking
    - AI-powered fraud detection for invoices
    - ML model performance monitoring
    - IoT integration for warehouse and fleet
*/
