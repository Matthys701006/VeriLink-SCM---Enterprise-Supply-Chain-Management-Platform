/*
  # VeriLink SCM Database Schema Setup

  1. Tables
    - Creates core tables for supply chain management system
  ...
  3. Functions
    - Business logic for inventory status updates
...
-- Add comment to warehouse total_capacity column
COMMENT ON COLUMN public.warehouses.total_capacity IS 'Total capacity in cubic meters';
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization suppliers'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization warehouses'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization inventory'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization purchase orders'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization po items'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization shipments'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization invoices'
    ) THEN
    ...
    IF NOT EXISTS (
        ...
        AND policyname = 'Users can manage organization payments'
    ) THEN
...
DROP TRIGGER IF EXISTS inventory_status_update ON inventory_items;
CREATE TRIGGER inventory_status_update
BEFORE INSERT OR UPDATE OF on_hand, reorder_point ON inventory_items
FOR EACH ROW
EXECUTE FUNCTION update_inventory_status();

DROP TRIGGER IF EXISTS warehouse_capacity_update ON inventory_items;
