/*
  # Fixed Analytics and ML Model Tables

  1. New Tables
    - `analytics_snapshots` - Store analytics snapshots for different time periods
    - `ml_models` - Machine learning model management and tracking

  2. Types
    - Types for analytics snapshot periods and ML model statuses

  3. Indexes and Policies
    - Performance indexes for analytics data
    - Fixed RLS policies using DROP IF EXISTS to avoid conflicts
*/
